  ...
  return (
    <div className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md shadow-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* Name */}
        <div>
          <label className="block text-xs font-semibold text-slate-400 mb-1">항목 이름</label>
          <input
            type="text"
            ...
            required
            className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-xs text-slate-200 placeholder-slate-600 focus:outline-none focus:border-cyan-500 font-medium"
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              required
              className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-xs text-slate-100 font-bold focus:outline-none focus:border-cyan-500 pr-8"
            />
            <span className="absolute right-3 top-2.5 text-xs font-bold text-slate-500">원</span>
          </div>
          <div className="mt-1 text-[11px] text-cyan-400/90 font-medium">{koreanAmountText}</div>
        </div>
        ...
        <div className="flex items-center justify-between pt-1">
          <span className="text-xs font-medium text-slate-400">매월 반복 고정 항목</span>
          <button
            type="button"
